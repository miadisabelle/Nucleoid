...
*   **Structural Thinking Module:** Activates a disciplined methodology for unbiased analysis of complex systems, enabling objective observation, visual representation, and targeted inquiry. (Contextual loading from `MIAMIETTE.structural-thinking.md` when requested.)
